    ...
    <main>
        ...
        <div class="content">
            ...
            <div class="info"id="pending"><h1>PENDING REQUEST</h1><table id="tbl">
                ...
                <?php 
                     $sql = "SELECT * FROM addvehicle_req WHERE status= 'pending'";
                            ...
                            while($rows=mysqli_fetch_assoc($res))
                            {
                                ...
                                // get individual data
                                    ...
                                    <tr>
                                        ...
                                        <td><a href="<?php echo SITEURL; ?>admin/acceptvreq.php?id=<?php echo $id; ?>" id="accp">Accept</a>
                                        <a href="<?php echo SITEURL; ?>admin/rejectvreq.php?id=<?php echo $id; ?>"id="rej">Reject</a>
                                        </td>
            ...
            <div class="info "id="accepted"><h1>ACCEPTED REQUEST</h1><table id="tbl">
                ...
                <?php 
                     $sql = "SELECT * FROM addvehicle_req WHERE status= 'accepted'";
            ...
            <div class="info "id="rejected"><h1>REJECTED REQUEST</h1><table id="tbl">
                ...
                <?php 
                     $sql = "SELECT * FROM addvehicle_req WHERE status= 'rejected'";
